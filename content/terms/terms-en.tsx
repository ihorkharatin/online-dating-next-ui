...
export default function TermsEn({ website }: { website: string }) {
  return (
    <div className={style.termsContainer}>
      ...
      <p>
        <strong>Your use of our Services.</strong> Subject to your compliance
      ...
      <p>
        <strong>Your submissions and contributions.</strong> Please review this
        section and the <strong>‘PROHIBITED ACTIVITIES’</strong> section
      ...
      <p>
        ...
        treated as a Contribution. You understand that Contributions may be
      ...
      <p>
        ...
        works, your Contributions, and to sublicense the licences granted in
      ...
      <p>
        <strong>We reserve the right to remove or edit your Content:</strong> We
        have the right to monitor any Contributions, we shall have the right to
        ...
        shall also suspend or disable your account and report you to the
        authorities.
      </p>
      ...
      <p>
        ...
        illegal activities related to prostitution and human trafficking. <br />
      ...
      <p>
        ...
        can be a hard ask but here are some signs to look out for:
      </p>
      <p>
        <strong>· Instant Love.</strong> If he’s professing his undying love
        within a few days of knowing you, there’s more than one reason to think
        there might be something wrong here. The first step to trapping their
        potential victim is to get her emotionally involved. Therefore, it is
        always advisable to take the time to get to know other members on the
        site as someone you have only known for a few days is more likely to be
        a fraud than someone you have been chatting with for a few months.
      </p>
      <p>
        <strong>· Job Promises.</strong> This is the most common bait sex
        traffickers use. They will usually promise you a job, tell you to come
        to a different country where you can work (often as a waitress), promise
        you big money and the like. But when you reach the other country,
        there’s no job waiting for you and most often these sex traffickers use
        the promise of a job to trick and coerce women into prostitution.
      </p>
      <p>
        <strong>· Willingness to Pay.</strong> There are a number of men out
        there who are genuinely willing to sponsor their girlfriend to be able
        to visit them. While most men are legitimate, there are some who use
        this as a ploy and girls are often forced into prostitution and
        subsequently made to “pay off the debt”. Not everyone is trying to dupe
        you but if someone’s behavior is suspicious and they are over eager for
        you visit them, you should think twice. For example, if you have only
        been chatting with them for a few days and they are offering to pay for
        everything already, it could be dodgy.
      </p>
      <p>
      ...
      <p>
        ...
        meet them. It is much safer if you ask him to visit you rather than you
      ...
      <p>
        <strong>Locate the Report Feature:</strong> Visit the profile of the
        member in question. Find and click the ‘Report’ button, typically
        visible on every member’s profile page. <br />
        <strong>Choose the Relevant Category:</strong> After clicking the
        ‘Report’ button, you will be prompted to select a reason for your
        report. Choose ‘Solicitation / Escort / Requesting Money’ from the list
        of options to indicate the nature of the violation accurately. <br />
        <strong>Submit Your Report:</strong> Once you’ve selected the
        appropriate category, confirm your action by clicking the ‘Report’
        button to finalize your submission. This notifies our team, who will
        then review the report and take necessary actions in alignment with our
      ...
      <p>
        ...
        the Services are hosted in United Kingdom. If you access the Services
        ...
        applicable laws in United Kingdom, then through your continued use of
        the Services, you are transferring your data to United Kingdom, and you
      ...
      <p>
        ...
        Legal Terms (each a ‘Dispute’ and collectively, the ‘Disputes’) brought
      ...
      <p>
        <strong>Binding Arbitration.</strong> Any dispute arising from the
      ...
      <p>
        ...
        shall be the law of United Kingdom.
      </p>
      <p>
        <strong>Restrictions.</strong> The Parties agree that any arbitration
